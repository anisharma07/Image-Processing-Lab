...
# fig.suptitle("Original Image and Histograms", fontsize=16)
fig.canvas.manager.set_window_title("Original Boat Image")
...
# red channel
# axs[1, 1].set_title("Red Channel Histogram")
...
# green channel
# axs[1, 2].set_title("Green Channel Histogram")
...
# green channel
# axs[1, 3].set_title("Blue Channel Histogram")
