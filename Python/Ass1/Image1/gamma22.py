...
image_path = './Ass1/Image1/log_transform/gamma_transformed_gamma_2.2.jpg'
...
fig.canvas.manager.set_window_title("gamma 2.2 Boat Image")


# Display the RGB image
axs[0, 0].imshow(image_rgb)
axs[0, 0].set_title("Gamma 2.2 Image")
axs[0, 0].axis('off')
...
axs[0,3].imshow(blue_channel, cmap='gray')
