...
image_path = './Ass1/Image1/abc1/sub_sampled.bmp'
...
# fig.suptitle("Subsampled Image and Histograms", fontsize=16)
fig.canvas.manager.set_window_title("Subsampled Image")


# Display the RGB image
axs[0, 0].imshow(image_rgb)
axs[0, 0].set_title("Subsampled Image")
axs[0, 0].axis('off')
